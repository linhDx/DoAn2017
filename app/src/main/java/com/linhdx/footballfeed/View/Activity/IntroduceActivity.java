...
public class IntroduceActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (SharedPreferencesUtil.getStringPreference(IntroduceActivity.this, AppConstant.FIRST_LAUNCH_APP) != null) {
            launchMainScreen();
            finish();
        }
    ...
    private void launchMainScreen() {
        SharedPreferencesUtil.setStringPreference(IntroduceActivity.this, AppConstant.FIRST_LAUNCH_APP, "fist");
