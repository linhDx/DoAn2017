...
public class SharedPreferencesUtil {
    private static final String PREF_KEY_INTRODUCE = "introduce";

    public static void setFinishIntroduce(Context context) {
        setBooleanPreference(context, PREF_KEY_INTRODUCE, true);
    }

    public static boolean isFinishIntroduce(Context context) {
        return getBooleanPreference(context, PREF_KEY_INTRODUCE, false);
    }

    /**
     * Core shared preference. Don't change anything below
     */
